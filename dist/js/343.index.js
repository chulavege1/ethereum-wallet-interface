...
(self.webpackChunkethereum_wallet_interface =
  ...
  [343],
  {
    ...
    8764: (t, e, r) => {
      ...
      (f.TYPED_ARRAY_SUPPORT = (function () {
        ...
        (f.compare = function (t, e) {
          if (
            (q(t, Uint8Array) && (t = f.from(t, t.offset, t.byteLength)),
            q(e, Uint8Array) && (e = f.from(e, e.offset, e.byteLength)),
      ...
      function V(t, e, r) {
        if (Math.floor(t) !== t)
          throw (
            (F(t, r), new k.ERR_OUT_OF_RANGE(r || "offset", "an integer", t))
          );
            ...
            e = Math.abs(e),
              isNaN(e) || e === 1 / 0
                ...
                : ((s = Math.floor(Math.log(e) / Math.LN2)),
                  ...
                  (e += s + c >= 1 ? h / f : h * Math.pow(2, 1 - c)) * f >= 2 &&
                    (s++, (f /= 2)),
                  s + c >= l
                    ? ((a = 0), (s = l))
                    : s + c >= 1
                    ? ((a = (e * f - 1) * Math.pow(2, o)), (s += c))
    ...
    8448: (t, e, r) => {
      ...
      var n = r(2478);
      const o = (t) => "object" == typeof t && null !== t,
        i = new WeakMap(),
        s = new WeakSet(),
        [a] = ((
          t = Object.is,
          ...
          r = (t) =>
            o(t) &&
            !s.has(t) &&
            (Array.isArray(t) || !(Symbol.iterator in t)) &&
          ...
          h = (a) => {
            ...
            const w = (t) => (e, r) => {
              ...
              m = (t) => {
                var e;
                const r = b.get(t);
                r && (b.delete(t), null == (e = r[1]) || e.call(r));
              },
              E = Array.isArray(a)
                ? []
              ...
              v = e(E, {
                deleteProperty(t, e) {
                  ...
                  return n && g(["delete", [e], r]), n;
                },
                set(e, a, f, u) {
                  const c = Reflect.has(e, a),
                    p = Reflect.get(e, a, u);
                  if (c && (t(p, f) || (l.has(f) && t(p, l.get(f))))) return !0;
                  m(a), o(f) && (f = (0, n.o5)(f) || f);
                  let y = f;
                  ...
                  return Reflect.set(e, a, y, u), g(["set", [a], f, p]), !0;
                },
              });
            l.set(a, v);
            const I = [
            ...
            return (
              ...
              Reflect.ownKeys(a).forEach((t) => {
                ...
                "value" in e &&
                  ((v[t] = a[t]), delete e.value, delete e.writable),
                  Object.defineProperty(E, t, e);
              }),
              v
            );
          },
        ) => [h, i, s, t, e, r, a, f, u, l, c])();
      function f(t = {}) {
        return a(t);
      }
      function u(t, e, r) {
      ...
      const c = f({
        ...
        h = {
          ...
          push(t, e) {
            t !== c.view &&
              ((c.view = t), e && (c.data = e), c.history.push(t));
          },
          reset(t) {
            (c.view = t), (c.history = [t]);
          },
          replace(t) {
            c.history.length > 1 &&
              ((c.history[c.history.length - 1] = t), (c.view = t));
          },
          goBack() {
            if (c.history.length > 1) {
              c.history.pop();
              const [t] = c.history.slice(-1);
              c.view = t;
            }
          },
          setData(t) {
        ...
        p = {
          ...
          formatNativeUrl(t, e, r) {
            ...
            return (
              ...
              `${n}wc?uri=${encodeURIComponent(e)}`
            );
          },
          formatUniversalUrl(t, e, r) {
            if (!p.isHttpUrl(t)) return this.formatNativeUrl(t, e, r);
            let n = t;
            return (
              n.endsWith("/") || (n = `${n}/`),
              this.setWalletConnectDeepLink(n, r),
          ...
          setModalVersionInStorage() {
            try {
              typeof localStorage < "u" &&
                localStorage.setItem(p.WCM_VERSION, "2.5.9");
            } catch {
          ...
          getWalletRouterData() {
            var t;
            const e = null == (t = h.state.data) ? void 0 : t.Wallet;
        ...
        m = {
          ...
          setConfig(t) {
            var e, r;
            g.initialize(),
              w.setChains(t.chains),
              w.setIsAuth(Boolean(t.enableAuthMode)),
              w.setIsCustomMobile(
                Boolean(null == (e = t.mobileWallets) ? void 0 : e.length),
              ),
        ...
        E = "https://explorer-api.walletconnect.com";
      ...
      const I = async (t) => v("/w3m/v1/getDesktopListings", t),
        A = async (t) => v("/w3m/v1/getMobileListings", t),
        B = async (t) => v("/w3m/v1/getAllListings", t),
        U = (t) =>
          `${E}/w3m/v1/getWalletImage/${t}?projectId=${m.state.projectId}`,
        C = (t) =>
          `${E}/w3m/v1/getAssetImage/${t}?projectId=${m.state.projectId}`;
      ...
      const M = p.isMobile(),
        ...
        W = {
          ...
          async getRecomendedWallets() {
            ...
            if ("NONE" === t || ("ALL" === e && !t)) return S.recomendedWallets;
            if (p.isArray(t)) {
              const e = { recommendedIds: t.join(",") },
                { listings: r } = await B(e),
                n = Object.values(r);
              n.sort((e, r) => t.indexOf(e.id) - t.indexOf(r.id)),
                (S.recomendedWallets = n);
            } else {
              const { chains: t, isAuth: r } = w.state,
                n = t?.join(","),
                o = p.isArray(e),
                i = {
                  page: 1,
                ...
                { listings: s } = M ? await A(i) : await I(i);
              S.recomendedWallets = Object.values(s);
            }
            return S.recomendedWallets;
          },
          async getWallets(t) {
            const e = ((t, e) => {
                for (var r in e || (e = {})) R.call(e, r) && j(t, r, e[r]);
                if (L) for (var r of L(e)) T.call(e, r) && j(t, r, e[r]);
                return t;
              })({}, t),
              {
              ...
              { recomendedWallets: o } = S;
            if ("ALL" === n) return S.wallets;
            o.length
              ? (e.excludedIds = o.map((t) => t.id).join(","))
              : p.isArray(r) && (e.excludedIds = r.join(",")),
              p.isArray(n) &&
                (e.excludedIds = [e.excludedIds, n].filter(Boolean).join(",")),
              w.state.isAuth && (e.sdks = "auth_v1");
            const { page: i, search: s } = t,
              { listings: a, total: f } = M ? await A(e) : await I(e),
              u = Object.values(a),
              l = s ? "search" : "wallets";
            return (
              (S[l] = {
                listings: [...S[l].listings, ...u],
                total: f,
                page: i ?? 1,
              }),
              { listings: u, total: f }
          ...
          getWalletImageUrl: (t) => U(t),
          getAssetImageUrl: (t) => C(t),
          resetSearch() {
        ...
        P = {
          ...
          open: async (t) =>
            new Promise((e) => {
              const { isUiLoaded: r, isDataLoaded: n } = w.state;
              if (
                (w.setWalletConnectUri(t?.uri),
                w.setChains(t?.chains),
                h.reset("ConnectWallet"),
                r && n)
              )
                (_.open = !0), e();
              else {
      ...
      const z = f({
        ...
        F = {
          ...
          setThemeConfig(t) {
            ...
            e && (z.themeMode = e),
              r &&
                (z.themeVariables = ((t, e) => {
                  for (var r in e || (e = {})) k.call(e, r) && $(t, r, e[r]);
                  if (N) for (var r of N(e)) D.call(e, r) && $(t, r, e[r]);
                  return t;
                })({}, r));
          },
        },
        V = f({ open: !1, message: "", variant: "success" }),
        H = {
          state: V,
          subscribe: (t) => u(V, () => t(V)),
          openToast(t, e) {
            (V.open = !0), (V.message = t), (V.variant = e);
          },
          closeToast() {
            V.open = !1;
          },
      ...
      typeof window < "u" &&
        (window.Buffer || (window.Buffer = l.lW),
      ...
      class o {
        constructor(t) {
          (this.openModal = n.jb.open),
            ...
            n.ThemeCtrl.setThemeConfig(t),
            n.ConfigCtrl.setConfig(t),
            this.initUi();
        }
        async initUi() {
          if (typeof window < "u") {
            await Promise.all([r.e(4), r.e(839)]).then(r.bind(r, 4839));
